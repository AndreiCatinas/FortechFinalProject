...
public class EmployeeController {
	...
	/*
	 * @RequestMapping(method = RequestMethod.GET, value = "/employees/{id}") public
	 * ModelAndView getEmployee(ModelAndView mav, @PathVariable Integer id) {
	 * mav.getModel().put("employee", employeeService.getEmployee(id));
	 * mav.setViewName("redirect:/employees"); return mav; }
	 */
	...
	public ModelAndView updateEmployee(ModelAndView mav, @ModelAttribute @Valid Employee employee,
